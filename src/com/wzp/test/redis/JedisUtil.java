...
//			jedisConf.setMaxTotal(30);
			jedisConf.setTestOnBorrow(true);
			jedisConf.setMaxIdle(10);
//			jedisConf.setMaxWaitMillis(10000);
			...
			try {
				 ...
				 */
				pool = new JedisPool(jedisConf, ip, port, 2000);
				maps.put(key, pool);
			} catch (Exception e) {
				e.printStackTrace();
			}
	...
	public Jedis getJedis(String ip, int port) {
		...
		try {
			...
			log.log(Level.SEVERE, "get redis master1 failed!", e);
			// 销毁对象
