...
public class DH {
    ...
    public static void main(String[] args) throws Exception {  
        ...
        System.out.println("甲方公钥："+Base64Utils.encodeToString(publicKey1));  
        System.out.println("甲方私钥："+Base64Utils.encodeToString(privateKey1)); 
        // 由甲方的公钥产生的密钥对  
        ...
        System.out.println("乙方公钥："+Base64.encodeBase64(publicKey2));  
        System.out.println("乙方私钥："+Base64.encodeBase64(privateKey2));  
        //====================================================================//
        //组装甲方的本地加密密钥,由乙方的公钥和甲方的私钥组合而成  
        byte[] key1 = DH.getSecretKey(publicKey2, privateKey1);  
        System.out.println("甲方的本地密钥：" + Base64.encodeBase64(key1));  
        //组装乙方的本地加密密钥，由甲方的公钥和乙方的私钥组合而成  
        byte[] key2 = DH.getSecretKey(publicKey1, privateKey2);  
        System.out.println("乙方的本地密钥：" + Base64.encodeBase64(key2));  
        //====================================================================//
        String str="www.what21.com";  
        // 甲方进行数据的加密  
        byte[] code1 = DH.encrypt(str.getBytes(), key1);  
        System.out.println("加密后的数据：" + Base64.encodeBase64(code1));  
        //====================================================================//
        //乙方进行数据的解密  
